...
locals {
  ...
  anyware                            = "0.0.0.0/0"
  cidr                               = "172.0.0.0/8"
  security-group-name                = "ansible-${terraform.workspace}"
  http                               = 80
  ssh                                = 22


  // lodals for ec2
  ec2-master-name = "ec2-ansible-master-${terraform.workspace}"
  ec2-node-name   = "ec2-ansible-node-${terraform.workspace}"
  ec2-ssh-key     = "sshkey"
}